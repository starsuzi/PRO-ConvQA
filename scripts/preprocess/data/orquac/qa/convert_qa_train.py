...
with open('densephrases-data/convqa/orquac/original/preprocessed/train.txt') as f:
    ...
    for data in total_data:
        ...
        dict_data['answers'] = [dict_data['answers_answerstart']['text']]
...
with open('densephrases-data/convqa/orquac/preprocessed/qa/train_answer_'+str(window_size)+'.json', "w") as writer: 
